...
/*RamPosPid*/       {3,0,0       ,PID_DEFAULT_ERRALL_MAX,PID_DEFAULT_OUTPUT_MAX,PID_DEFAULT_OUTPUT_STEP_MAX,40,Ramp_e,PositionPID_e},
...
/*ScopeUMotor*/     {M2006,ECD_MODE,ROLL_ANGLE,NORMAL},
    ...
    float ChassisYawTarget=265;//随动模式下正方向的角度
